...
const uplooadProgress = ref(null);
...
onMounted(() => {
    dropzone = new Dropzone('div#video-dropzone', {
        ...
        init() {
            ...
            this.on('uploadprogress', (file, progress, bytesSend) => {
                uplooadProgress.value = progress;
            });
        }
    });
})
...
<template>
    <AppLayout title="Dashboard">
        <Panel>
            ...
            <form @submit.prevent="submit" class="grid grid-cols-1 md:grid-cols-2 gap-2">
                ...
                <div>
                    ...
                    <div v-if="uplooadProgress !== null">
                        <p v-if="uplooadProgress < 100">
                            Postęp {{ uplooadProgress }}%
                        </p>
                        <p v-else>
                            Ukończono przesyłanie plików
                        </p>
                    </div>
